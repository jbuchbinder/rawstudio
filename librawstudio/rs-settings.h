...
typedef enum {
	...
	MASK_VIGNETTING     = MASK_VIGNETTING_K1 | MASK_VIGNETTING_K2 | MASK_VIGNETTING_K3,
	MASK_CHANNELMIXER_RED = (1<<15),
	MASK_CHANNELMIXER_GREEN = (1<<16),
	MASK_CHANNELMIXER_BLUE = (1<<17),
